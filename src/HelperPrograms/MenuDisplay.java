...
public class MenuDisplay {
            ...
            switch (option) {
                case "0" -> {
                    ...
                    if (choice.equalsIgnoreCase("y")) {
                        ...
                        System.out.println("\nInvalid command choice! Returning to main menu...");
                        TimeUnit.SECONDS.sleep(1);
                        userInterface();
                    }
                    isRunning = false;
    ...
    public void selectCSVFileAsDatabase() throws InterruptedException {
        System.out.println("\n+----------------------------------------------------------------+");
        ...
        if (choice.equals("1")) {
            System.out.println("\nThe system will automatically use 'default.csv' as its database file...");
            TimeUnit.SECONDS.sleep(1);
            userInterface();
